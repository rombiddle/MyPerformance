...
//  MyPerformance
//
//  Created by Romain BRUNIE on 14/08/15.
...
class EditTableViewController: UITableViewController {
    ...
    @IBAction func addButtonPressed(sender: UIBarButtonItem) {
        let alerController = UIAlertController(title: "", message: "" ,preferredStyle: .Alert)
...
//            var t = alerController.textFields?[0] as! UITextField
//            if indexPath.row == 1{
//                t.text = t.text + " in"
//            }
